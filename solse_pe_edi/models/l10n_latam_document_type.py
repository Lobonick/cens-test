...
class L10nLatamDocumentType(models.Model):
	...
	nota_credito = fields.Many2one('l10n_latam.document.type', string='Nota credito', domain="[('code', '=', '07'), ('company_id', '=', company_id)]")
	nota_debito = fields.Many2one('l10n_latam.document.type', string='Nota debito', domain="[('code', '=', '08'), ('company_id', '=', company_id)]")
