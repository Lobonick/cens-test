# -*- coding: utf-8 -*-
# Copyright (c) 2024 Juan Gabriel Fernandez More (kiyoshi.gf@gmail.com)
...
class AccountPaymentRegister(models.TransientModel):
	...
	def _create_payment_vals_from_wizard(self, batch_result):
		_logging.info("======================== 2222222222222222222222")
		payment_vals = super(AccountPaymentRegister, self)._create_payment_vals_from_wizard(batch_result)
		_logging.info("datos antes de pagar")
		_logging.info(payment_vals)
		...
		if self.tipo == 'detraccion' and factura.move_type == 'out_invoice':
			...
			_logging.info(self.payment_difference)
			_logging.info(diferencia)
			_logging.info(crear_diferencia)
	...
	def _create_payments(self):
		...
		_logging.info(":::::::::::::::::::::::::: antes de pagar")
		if edit_mode:
			_logging.info("es editable")
			...
			for batch_result in batches:
				...
				if self.tipo == 'normal' and batch_result['payment_values']['account_id'] == cuenta_det_id:
					continue
				to_process.append({
					'create_vals': self._create_payment_vals_from_wizard(batch_result),#self._create_payment_vals_from_batch(batch_result),
					'to_reconcile': batch_result['lines'],
					'batch': batch_result,
				})
		...
		if payments and self.tipo == 'detraccion' and not self.autodetraccion and not self.group_payment and len(payments) == 1:
			...
			if not factura.pago_detraccion:
			...
			for pago in payments:
				...
				if factura_p and not factura_p.pago_detraccion:
