...
/**
 A line of some TaxTotalsComponentPE, giving the values of a tax group.
 **/
...
/**
 ...
 currency_id field.
 **/
export class TaxTotalsComponentPE extends Component {
    setup() {
        super.setup();
    ...
    _computeTotalsFormat() {
        ...
        let amount_total = amount_untaxed + amount_tax;
        amount_total = amount_total - this.totals['monto_gratuito'] - this.totals['monto_descuento']
...
TaxTotalsComponentPE.template = "account.TaxTotalsField";
TaxTotalsComponentPE.components = { TaxGroupComponent };
TaxTotalsComponentPE.props = {
    ...standardFieldProps,
};

registry.category("fields").add("account-tax-totals-field-pe", TaxTotalsComponentPE);
