...
class HrPayslip(models.Model):
    ...
    def export_to_spreadsheet(self):
        ...
        try:
            ...
            worksheet.write('CA8', 'COSTO EMPLEADO', cell_format_tit5)              #-- 68
            ...
            worksheet.write('CA9', '(Mensual)', cell_format_sub5)         #-- 75      COSTO MENSUAL
            ...
            for w_boleta in w_lote:
                ...
                # COSTO DEL MES
                # -----------------------------------------
                worksheet.write(w_fila, 78, w_boleta.x_studio_en_total_extraordinario, cell_format_imp2)
