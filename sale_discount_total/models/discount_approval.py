...
class sale_discount(models.Model):
    ...
    state = fields.Selection(selection_add=[('waiting', 'Waiting Approval')], ondelete={'annul': 'cascade'}, string='Status', readonly=True, copy=False, index=True, tracking=True, default='draft')
