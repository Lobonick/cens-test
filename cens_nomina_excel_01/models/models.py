...
class HrPayslip(models.Model):
    ...
    def export_to_spreadsheet(self):
        ...
        try:
            ...
            worksheet.set_column(64, 64, 12)    #--    INCREMENTOS DIRECTOS 
            ...
            worksheet.set_column(70, 70, 12)     #--    RESUMEN  
            ...
            worksheet.set_column(79, 79, 12)    #   --   COSTO MENSUAL
            worksheet.set_column(80, 80, 12)
            worksheet.set_column(81, 81, 12)

            worksheet.set_column(82, 82, 5)    #  

            worksheet.set_column(83, 83, 30)
            worksheet.set_column(84, 84, 30)    #--    BANCOS
            worksheet.set_column(85, 85, 40)    #-
            ...
            worksheet.write('BK8', 'TOTAL INCR.DIREC', cell_format_tit5)        #-- 58
            worksheet.write('BL8', 'TOTAL CONCEPTOS LBS', cell_format_tit8)        #-- 58
            ...
            worksheet.write('BY8', 'CUENTA', cell_format_tit7)              #-- 65
            ...
            for w_boleta in w_lote:
                ...
                worksheet.write(w_fila, 9, w_boleta.x_studio_movilidad, cell_format_impo)
                worksheet.write(w_fila, 10, w_boleta.x_studio_vale_alimentos, cell_format_impo)
                worksheet.write(w_fila, 11, w_boleta.x_studio_condiciones_laborales, cell_format_impo)
                worksheet.write(w_fila, 12, w_boleta.x_studio_bonificacion_educacion, cell_format_impo)
                worksheet.write(w_fila, 13, w_boleta.x_studio_utilidades_voluntarias, cell_format_impo)
                # ----------------------------
                # -- REGISTRO EGRESOS --
                # ----------------------------
                worksheet.write(w_fila, 14, w_boleta.x_studio_descuento_inasistencias, cell_format_impo)
                worksheet.write(w_fila, 15, w_boleta.x_studio_dias_sin_goce, cell_format_impo)
                worksheet.write(w_fila, 16, w_boleta.x_studio_adelanto_sueldo, cell_format_impo)
                worksheet.write(w_fila, 17, w_boleta.x_studio_descuento_tardanzas_min, cell_format_impo)
                worksheet.write(w_fila, 18, w_boleta.x_studio_retencion_judicial, cell_format_impo)
                worksheet.write(w_fila, 19, w_boleta.x_studio_descuento_prestamos, cell_format_impo)
                ...
                # -----------------------------------------
                worksheet.write(w_fila, 21, w_boleta.x_studio_en_basico, cell_format_impo)
                worksheet.write(w_fila, 22, w_boleta.x_studio_en_asignacion_familiar, cell_format_impo)
                worksheet.write(w_fila, 23, w_boleta.x_studio_en_licencia_con_ghaber, cell_format_impo)
                worksheet.write(w_fila, 24, w_boleta.x_studio_en_licencia_fallecimiento, cell_format_impo)
                worksheet.write(w_fila, 25, w_boleta.x_studio_en_licencia_materpater, cell_format_impo)
                worksheet.write(w_fila, 26, w_boleta.x_studio_en_bonificacion_cumplimiento, cell_format_impo)
                worksheet.write(w_fila, 27, w_boleta.x_studio_en_descanso_medico, cell_format_impo)
                worksheet.write(w_fila, 28, w_boleta.x_studio_en_feriados, cell_format_impo)
                worksheet.write(w_fila, 29, w_boleta.x_studio_en_horas_extras, cell_format_impo)
                worksheet.write(w_fila, 30, w_boleta.x_studio_en_vacaciones, cell_format_impo)
                worksheet.write(w_fila, 31, w_boleta.x_studio_en_descanso_vacacional, cell_format_impo)
                # -----------------------------------------
                # BOLETA PAGO - CONCEPTOS NO REMUNERATIVOS
                # -----------------------------------------
                worksheet.write(w_fila, 32, w_boleta.x_studio_en_vale_alimentacion, cell_format_impo)
                worksheet.write(w_fila, 33, w_boleta.x_studio_en_vale_movilidad, cell_format_impo)
                worksheet.write(w_fila, 34, w_boleta.x_studio_en_condiciones_laborales, cell_format_impo)
                worksheet.write(w_fila, 35, w_boleta.x_studio_en_bonificacion_educacion, cell_format_impo)
                worksheet.write(w_fila, 36, w_boleta.x_studio_en_utilidades_voluntarias, cell_format_impo)
                worksheet.write(w_fila, 37, w_boleta.x_studio_en_reembolso_combustible, cell_format_impo)

                # -----------------------------------------
                # BOLETA PAGO - CONCEPTOS DE LIQUIDACIÓN  - ASIGNAR CAMPOS REALES
                # -----------------------------------------
                worksheet.write(w_fila, 38, w_boleta.x_studio_cese_vaca_trunca, cell_format_impo)
                worksheet.write(w_fila, 39, w_boleta.x_studio_cese_cts_trunco, cell_format_impo)
                worksheet.write(w_fila, 40, w_boleta.x_studio_cese_grati_trunca, cell_format_impo)
                worksheet.write(w_fila, 41, w_boleta.x_studio_cese_bonif_grati_trunca, cell_format_impo)

                # -----------------------------------------
                # BOLETA PAGO - DESCUENTOS
                # -----------------------------------------
                worksheet.write(w_fila, 42, w_boleta.x_studio_en_licencia_sin_ghaber, cell_format_impo)
                worksheet.write(w_fila, 43, w_boleta.x_studio_en_adelanto_sueldo, cell_format_impo)
                if (w_boleta.x_studio_compania_afp):
                    w_nombre_cia = w_boleta.x_studio_compania_afp.x_name
                    worksheet.write(w_fila, 44, w_nombre_cia, cell_format_left)
                    if (w_nombre_cia == 'ONP'):
                        worksheet.write(w_fila, 46, w_boleta.x_studio_en_afp_onp, cell_format_impo)
                    else:
                        worksheet.write(w_fila, 45, w_boleta.x_studio_en_afp_onp, cell_format_impo)
                worksheet.write(w_fila, 47, w_boleta.x_studio_en_inasistencias, cell_format_impo)
                worksheet.write(w_fila, 48, w_boleta.x_studio_en_tardanzas, cell_format_impo)
                worksheet.write(w_fila, 49, w_boleta.x_studio_en_renta_5ta, cell_format_impo)
                worksheet.write(w_fila, 50, w_boleta.x_studio_en_retencion_judicial, cell_format_impo)
                worksheet.write(w_fila, 51, w_boleta.x_studio_en_descuento_prestamos, cell_format_impo)
                worksheet.write(w_fila, 52, w_boleta.x_studio_aporte_eps_2, cell_format_impo)
                # -----------------------------------------
                # BOLETA PAGO - INCREMENTOS DIRECTOS
                # -----------------------------------------
                worksheet.write(w_fila, 53, w_boleta.x_studio_en_reembolso, cell_format_impo)
                worksheet.write(w_fila, 54, w_boleta.x_studio_en_reembolso_movilidad, cell_format_impo)
                worksheet.write(w_fila, 55, w_boleta.x_studio_en_adelanto_gratificacion, cell_format_impo)
                worksheet.write(w_fila, 56, w_boleta.x_studio_en_indemniza_despido_arbitrario, cell_format_impo)
                worksheet.write(w_fila, 57, w_boleta.x_studio_especial_ac, cell_format_impo)
                ...
                worksheet.write(w_fila, 59, w_boleta.x_studio_en_gross, cell_format_impo)
                ...
                # APORTES
                # -----------------------------------------
                worksheet.write(w_fila, 66, w_boleta.x_studio_aporte_a_essalud, cell_format_impo)
                worksheet.write(w_fila, 67, w_boleta.x_studio_en_aportes_eps, cell_format_impo)
                # -----------------------------------------
                # PROVISIONES
                # -----------------------------------------
                worksheet.write(w_fila, 68, w_boleta.x_studio_en_provision_cts, cell_format_impo)
                worksheet.write(w_fila, 69, w_boleta.x_studio_en_provision_vacaciones, cell_format_impo)
                worksheet.write(w_fila, 70, w_boleta.x_studio_en_provision_gratificacion, cell_format_impo)
                worksheet.write(w_fila, 71, w_boleta.x_studio_en_provision_bonigrati, cell_format_impo)
                # -----------------------------------------
                # COSTO DEL MES
                # -----------------------------------------
                worksheet.write(w_fila, 73, w_boleta.x_studio_en_total_extraordinario, cell_format_imp2)

                # -----------------------------------------
                # COSTO DEL MES
                # -----------------------------------------
                w_dato = w_boleta.employee_id.x_studio_nombre_banco
                worksheet.write(w_fila, 74, w_dato, cell_format_imp2)

                w_dato = w_boleta.employee_id.x_studio_numero_cuenta
                worksheet.write(w_fila, 75, w_dato, cell_format_imp2)

                w_dato = w_boleta.employee_id.x_studio_cci
                worksheet.write(w_fila, 76, w_dato, cell_format_imp2)
