...
class ValidateAccountMove(models.TransientModel):
	_inherit = "solse.pe.cpe.report.wizard"
	...
	def generar_archivo(self):
		...
		for factura in facturas:
			...
			elif factura.data_xml:
				_document_name = factura.datas_fname
				filecontent = base64.b64decode(factura.data_xml)
				in_memory_zip.writestr(_document_name, filecontent)
				if factura.data_pdf:
					_document_name_pdf = factura.datas_fname_pdf
					filecontent_pdf = base64.b64decode(factura.data_pdf)
					in_memory_zip.writestr(_document_name_pdf, filecontent_pdf)
