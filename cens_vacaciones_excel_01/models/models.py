...
class HrLeaveExtended(models.Model):
    ...
    def export_to_spreadsheet(self):
        ...
        try:
            ...
            worksheet.set_column(4, 5, 15)      #-- FECHA INGRESO
            worksheet.set_column(5, 5, 13)      #-- 1
            worksheet.set_column(6, 6, 13)      #-- 2
            worksheet.set_column(7, 7, 13)      #-- 3
            worksheet.set_column(8, 8, 13)      #-- 4
            worksheet.set_column(9, 9, 13)      #-- 5
            worksheet.set_column(10, 10, 13)    #-- CODIGO AUSENCIA
            worksheet.set_column(11, 11, 15)    #-- PERIODO
            worksheet.set_column(12, 12, 15)    #-- FECHA INICIAL
            worksheet.set_column(13, 13, 15)    #-- FECHA FINAL
            worksheet.set_column(14, 14, 8)     #-- NRO DE DÍAS
            worksheet.set_column(15, 15, 15)    #-- ESTATUS
            worksheet.set_column(16, 16, 40)    #-- COMENTARIOS
            # ------
            ...
            worksheet.merge_range('F6:J6', 'Merged Cells', merge_format)
            worksheet.write('F6', 'CÁLCULO ACUMULADO', cell_format_tut2)

            worksheet.merge_range('K6:Q6', 'Merged Cells', merge_format)
            worksheet.write('K6', 'PERIODOS GOZADOS', cell_format_tuti)
            # -------------------------------------------------------------------------------------
            # BARRA DE TITULOS
            # -------------------------------------------------------------------------------------
            ...
            worksheet.write('F7', 'Total dias vacaciones acumuladas', cell_format_titu)     #-- 05
            worksheet.write('G7', 'Días Vacaciones Gozadas', cell_format_titu)              #-- 06
            worksheet.write('H7', 'Días vacaciones acumuladas truncas', cell_format_titu)   #-- 07
            worksheet.write('I7', 'Días Vacaciones pendientes', cell_format_titu)           #-- 08
            worksheet.write('J7', 'Total días Vacaciones Vencidas', cell_format_titu)       #-- 09
            worksheet.write('K7', 'CÓDIGO', cell_format_titu)                               #-- 10
            worksheet.write('L7', 'PERIODO', cell_format_titu)                              #-- 11
            worksheet.write('M7', 'FECHA INICIAL', cell_format_titu)                        #-- 12
            worksheet.write('N7', 'FECHA FINAL', cell_format_titu)                          #-- 13
            worksheet.write('O7', 'TOTAL DÍAS', cell_format_titu)                           #-- 14
            worksheet.write('P7', 'ESTADO', cell_format_titu)                               #-- 15
            worksheet.write('Q7', 'COMENTARIOS', cell_format_titu)                          #-- 16
                ...
                if current_employee != leave.employee_id:
                    if current_employee:
                        ...
                        for ausencia in w_agrupa_ausencias_ordenada:
                            ...
                            worksheet.write(w_fila, 10, ausencia['ausencia_codigo'], cell_format_tiny)
                            worksheet.write(w_fila, 11, ausencia['ausencia_periodo'], cell_format_cent)
                            worksheet.write(w_fila, 12, ausencia['ausencia_desde'], cell_format_fech)
                            worksheet.write(w_fila, 13, ausencia['ausencia_hasta'], cell_format_fech)
                            worksheet.write(w_fila, 14, ausencia['ausencia_numdias'], cell_format_nume)
                            worksheet.write(w_fila, 15, self.estatus_ausencia(ausencia['ausencia_state']), cell_format_perd if ausencia['ausencia_state'] == 'refuse' else cell_format_left)
                            if ausencia['ausencia_comenta']:
                                worksheet.write(w_fila, 16, ausencia['ausencia_comenta'], cell_format_left)
                            ...
                            worksheet.conditional_format(f'K{w_fila+1}:Q{w_fila+1}', {
                                    'type': 'formula',
